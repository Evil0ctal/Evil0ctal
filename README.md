# 👋 Hello! I'm Evil0ctal (Adam Tan)

![views](https://views.whatilearened.today/views/github/evil0ctal/views.svg)

Welcome to my GitHub page! I'm a developer passionate about exploring programming, reverse engineering, and cybersecurity, as well as a gamer who enjoys challenges and innovation. My technical journey started in middle school, and since then, I’ve built a diverse skill set and experience. Through continuous learning, I've delved into fields like  **data scraping** ,  **AI content analysis** , and  **high-performance backend systems** , aiming to drive innovation and practical applications in technology.

## About Me 🚀

* 💻  **Core Skills** : Python, asynchronous programming, reverse engineering, distributed systems, cybersecurity.
* 🚀  **Project Focus** : Designing and developing high-performance open-source tools, covering areas such as data scraping, speech recognition, and content analysis.
* 🌐  **Open Source Contribution** : With over 9000 stars on GitHub, I’m enthusiastic about sharing code and building tools that simplify social media data extraction and analysis.
* 🎓  **Learning and Growth** : From game plugin development to cybersecurity, and now AI-driven applications, my growth has been fueled by constant learning and technical expansion.
* 🌍  **Community Engagement** : Actively involved in the open-source community, collaborating and exchanging knowledge with global developers, reviewing PRs, and collectively improving technical expertise.
...
* 📸 Instagram: [Evil0ctal](https://www.instagram.com/evil0ctal/)
* 🎬 Bilibili: [Evil0ctal](https://space.bilibili.com/12505756)
* 📱Forum: [QwQ.dev](https://qwq.dev)
* 🕹 Play games with me on [Steam](https://steamcommunity.com/id/Evil0ctal)
* 💻 Contact:
...
## 🌐 My Collection of Interesting Domains
...
> **Background:**
> This was my personal website where I wrote blogs and hosted quirky tools. Though it’s no longer active due to data loss, I still own the domain.
...
> **Fun Interpretation:**
> As a developer, I like to joke that I "write code for God." This domain perfectly captures that spirit—LOL!
